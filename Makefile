...
behave-all: docker-compose.yaml
	@docker compose run django python manage.py behave --no-input --simple --no-capture info/tests/features/
...
behave: docker-compose.yaml
	@docker compose run django python manage.py behave --no-input --simple --no-capture info/tests/features/ -i $(FEATURE)
