...
class ApplianceAdmin(admin.ModelAdmin):
    list_display = ('name', 'model_number', 'serial_number', 'appliance_type', 'purchase_date')
...
class CircuitAdmin(admin.ModelAdmin):
    list_display = ('circuit_number', 'description', 'breaker_size', 'gfci', 'afci', 'cafi', 'pole_type')
    search_fields = ('circuit_number', 'description', 'breaker_size', 'pole_type', 'rooms__name')
